...
ExampleWindow::ExampleWindow(const Glib::RefPtr<Gtk::Application>& app)
    ...
    m_refActionRain =
        m_refActionGroup->add_action_bool("rain", [this] { on_action_toggle(); }, false);
    ...
    m_refActionGroup->add_action("cut", sigc::track_object([this] { on_action_others(); }, *this));
#else
    m_refActionGroup->add_action("cut", sigc::track_obj([this] { on_action_others(); }, *this));
#endif
...
void ExampleWindow::on_action_others() { std::cout << "A menu item was selected." << std::endl; }
