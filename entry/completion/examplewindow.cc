...
ExampleWindow::ExampleWindow()
    : m_VBox(Gtk::Orientation::VERTICAL),
      m_Label("Press a or b to see a list of possible completions."), m_Button_Close("Close") {
 ...
 * or you could look for the key in extra model columns as well as the model column that will be
displayed.
