...
ExampleWindow::ExampleWindow(const Glib::RefPtr<Gtk::Application>& app)
    : m_Box(Gtk::Orientation::VERTICAL), m_Label("Right-click to see the popup menu.") {
    ...
    m_refGesture->signal_pressed().connect(sigc::mem_fun(*this, &ExampleWindow::on_label_pressed));
...
ExampleWindow::~ExampleWindow() { m_MenuPopup.unparent(); }
