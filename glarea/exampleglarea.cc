...
// epoxy/gl.h is already included in exampleglarea.h, no need to include again here unless
// specifically needed later. #include <epoxy/gl.h>
...
const GLuint ExampleGLArea::m_default_cube_index_data[36] = {0,  3,  2,  0,  2,  1,
...
const GLuint ExampleGLArea::m_edge_index_data[12 * 2] = {0, 1, 1, 2, 2, 3, 3, 0,
...
ExampleGLArea::ExampleGLArea() {
    ...
    motion_controller->signal_motion().connect(
        sigc::mem_fun(*this, &ExampleGLArea::on_mouse_motion));
    ...
    click_controller_middle->signal_released().connect(
        sigc::mem_fun(*this, &ExampleGLArea::on_mouse_release));
